...
class StartGameView(RateLimitMixin, HomeAssistantView):
    ...
    async def post(self, request: web.Request) -> web.Response:
        ...
        # #1012: REVEAL auto-advance normalized against REVEAL_AUTO_ADVANCE_OPTIONS
        # (#2626). The fork keeps 10 and 15 in that tuple for the quick
        # "everyone tipped → short recap → next round" cadence.
        ...
        # The redundant per-provider capability guards the fork carried here were
        # dropped: upstream's single ``provider_spec.plays_on(platform)`` check
        # above (#2680) already covers youtube_music, tidal, deezer and amazon.
        create_options = GameOptions(
            ...
            title_artist_race_mode=title_artist_race_mode,  # fork: live Race
