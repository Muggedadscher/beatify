...
_PLAYER_VISIBLE_BASE = frozenset(
    {
        ...
        "title_artist_mode",
        # Fork: the live-buzzer Race variant. The guest's phone reads it to switch
        # to the unlimited-guess race UI, so it is player-visible like the mode
        # flag above; it carries no answer.
        "title_artist_race_mode",
        "is_intro_round",
        "intro_stopped",
